...
try:
    with open('/home/pi/home-automation/conf.json.dist') as data_file:
...
def send_welcome(message):
    ...
    print (unique_code)
    reply = "Hello I'm a private bot of Tiancheng's house. I only speak with Tiancheng."
...
def command_text_hi(m):
    if m.chat.id in allowedChatIDs:
        ...
        bot.send_message(m.chat.id, "Yes. I know. You aren't Tiancheng and I said that I only speak with Tiancheng but I'm polite.")
